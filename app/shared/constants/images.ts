...
export const RIDERS = "/assets/users.png";

export const MOTORBIKE = "/assets/motorbike.png";

export const COMPASS = "/assets/compass.png";

export const ADMIN = "/assets/admin.png";

export const SEARCH = "/assets/search.png";
